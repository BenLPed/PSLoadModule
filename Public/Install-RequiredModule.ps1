...
.EXAMPLE
'Pester','Az.Accounts' | Install-RequiredModule -Verbose
...
.EXAMPLE
Install-RequiredModule -ModuleName Az -MinimumVersion 11.0.0 -Verbose

Ensure Az (>= 11.0.0) is installed/imported.

.EXAMPLE
Install-RequiredModule -ModuleName Pester -RequiredVersion 5.6.0 -WhatIf
